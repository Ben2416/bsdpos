...
<head>
        <title>Eddinho POS</title><meta charset="UTF-8" />
    ...
    <body>
        <div id="loginbox">            
            <form id="loginform" class="form-vertical" action="<?=base_url('users/login')?>" method="post">
				 <div class="control-group normal_text"> <h3><img src="<?=base_url('assets/')?>img/ei_logo2.png" alt="Logo" /></h3></div>
